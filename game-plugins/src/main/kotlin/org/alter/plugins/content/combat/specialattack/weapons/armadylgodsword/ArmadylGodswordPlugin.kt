...
class ArmadylGodswordPlugin(
    ...
    init {
        ...
        // One binding for every Armadyl godsword - plain, (or), the untradeable 20593 and the
        // corrupted one - where this used to be the same block pasted out twice for two ids.
        SpecialAttacks.registerByName("The Judgement") {
